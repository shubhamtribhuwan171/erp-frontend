    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[--text-secondary]">Manage your vendors & suppliers</p>
        </div>
        <Link
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {loading ? (
          ...
          <div className="col-span-full text-center py-8 text-[--secondary]">
            No vendors found. <Link to="/purchases/vendors/new" className="text-[--primary] hover:underline">Add one</Link>
          </div>
        ) : (
          vendors.map((vendor) => (
            <div key={vendor.id} className="bg-white rounded-lg border border-[--border] p-4 hover:shadow-sm transition">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[--text-secondary]">{vendor.code}</p>
                  </div>
                </div>
