    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-lg border border-[var(--border)] p-4">
        <p className="text-sm text-[var(--text-secondary)]">
          We’ll build the full PO creation form next. This page exists so links don’t 404.
        </p>
        ...
        <div className="mt-4 flex gap-3">
          ...
          <Link to="/purchases/orders" className="px-4 py-2 border border-[var(--border)] rounded-lg hover:bg-gray-50">
            Cancel
          </Link>
        </div>
      </div>
